  ...
  return (
    <aside className="hidden w-[22rem] shrink-0 border-r border-white/[0.05] py-12 pl-8 pr-10 lg:block">
      <div className="space-y-12">
        ...
        <section>
          ...
          >
            <span className="relative z-[1] flex items-center justify-between">
              <span className="font-mono text-[12px] font-semibold uppercase tracking-[0.18em] text-white">
                New Industrial Intel
              </span>
              <Plus size={15} className="text-gold transition-transform group-hover:rotate-90" />
            </span>
          </button>
        </section>
            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`group flex w-full items-center gap-3 rounded-full border px-5 py-3 font-mono text-[13px] uppercase tracking-[0.2em] transition-all duration-300 ${
                    isActive
                ...
                >
                  <Inbox size={14} className={isActive ? 'text-gold' : 'text-white/30 group-hover:text-gold/70'} />
                  <span>{cat}</span>
                </button>
              );
            })}
        ...
        <section>
          ...
          <div className="liquid-glass relative space-y-5 rounded-[1.4rem] px-6 py-6">
            <div className="relative z-[1]">
              <p className="font-mono text-[11px] uppercase tracking-[0.26em] text-[#888]">Vector Store</p>
              <p className="mt-1.5 flex items-center gap-2.5 font-mono text-[13px] uppercase tracking-[0.18em] text-white">
                <span className="h-2 w-2 rounded-full bg-gold shadow-[0_0_12px_rgba(196,163,90,0.7)]" />
                Initialised
              </p>
            </div>
            <div className="relative z-[1]">
              <p className="font-mono text-[11px] uppercase tracking-[0.26em] text-[#888]">RAG Context</p>
              <p className="mt-1.5 flex items-center gap-2.5 font-mono text-[13px] uppercase tracking-[0.18em] text-white/80">
        ...
        <p className="font-mono text-[10px] uppercase tracking-[0.26em] italic text-white/20">
